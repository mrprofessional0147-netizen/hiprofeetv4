    ...
    <div className="flex min-h-screen items-center justify-center bg-ink px-5 py-20">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mt-3 text-base font-light leading-[1.78] text-white/60">
          Your submission is logged. Send the prefilled WhatsApp message to complete confirmation and we'll begin execution.
        </p>

        <div className="mt-6 flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/5 p-5 text-left">
          {[
            ["1", <><strong className="font-semibold text-white">Open WhatsApp below</strong> — your order details are prefilled.</>],
            ["2", <><strong className="font-semibold text-white">Send the message</strong> — we verify payment and assign your project immediately.</>],
            ["3", <><strong className="font-semibold text-white">Delivery in 2–5 days</strong> — you focus on operations, we handle execution.</>],
          ].map(([n, body]) => (
        ...
        <p className="mt-3 text-xs text-white/40">{WHATSAPP_DISPLAY} · Typical response within a few hours, business days.</p>
